...
export default function GenerateQuestionsPage() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const res = await fetch('https://udemy-apim.azure-api.net/api/generate-questions', {
        method: 'POST',
        headers: {
          'accept': 'application/json',
          'X-API-Key': apiKey,
    ...
    <div className="min-h-screen bg-gray-900 pt-16">
      <div className="flex">
        ...
        <div className="w-[calc(100%-500px)] p-12">
          ...
          >
            <h1 className="text-4xl font-bold text-white mb-4">Generate Questions</h1>
            ...
            <div className="space-y-6">
              <div className="bg-gray-800/50 rounded-lg p-6">
                <div className="flex items-center space-x-2 mb-6">
                  <span className="px-3 py-1 text-sm font-medium bg-blue-500/10 text-blue-400 rounded">POST</span>
                  <code className="text-gray-300">/api/generate-questions</code>
                  <button 
                    className={cn(
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={cn(
                        "w-full bg-gray-900/50 border rounded-lg px-4 py-2 text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500",
                        validationError && !certificationName ? "border-red-500" : "border-gray-700"
                      )}
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-gray-400 mb-2">
                      Questions Per Topic <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="number"
                      ...
                      className={cn(
                        "w-full bg-gray-900/50 border rounded-lg px-4 py-2 text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500",
                        validationError && !questionsPerTopic ? "border-red-500" : "border-gray-700"
                      )}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={cn(
                        "w-full bg-gray-900/50 border rounded-lg px-4 py-2 text-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500",
                        validationError && !topics ? "border-red-500" : "border-gray-700"
                      )}
                    />
                    <p className="mt-2 text-sm text-gray-500">Comma-separated list of topics</p>
                  </div>
